...
// Query returns an Object struct that we can use to register all th top level
...
// Mutation returns an Object struct that we can use to register all th top level
